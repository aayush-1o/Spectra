/**
 * Spectra — Search Page
 * Global search bar → person cards → click to navigate to Graph.
 */
    ...
    return (
        <Layout>
            <div className="mb-6">
                ...
                <p className="text-slate-500 text-sm mt-1">Find a synthetic person and explore their network.</p>
            </div>
            ...
            {results.length > 0 && (
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {results.map((p) => (
                        <button
                            key={p.id}
                            onClick={() => navigate('/graph', { state: { person: p } })}
