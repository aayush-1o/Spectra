# ETHICS.md — Spectra Data Ethics Statement

> This document explains what Spectra does, what it deliberately does NOT do,
...
Spectra is a **portfolio and learning project** that simulates the appearance of a data-analytics platform using computer-generated data. It was built to demonstrate technical skills in backend development, graph databases, anomaly detection, and frontend dashboards.

All data in the system was generated by the application's own data engine:
...
Spectra is **not** a surveillance tool.
Spectra **cannot** track real people.
Spectra **does not** collect, store, or process any real personal information.
Spectra **was not** designed to be used on real data. It actively rejects it.
...
- No real-time data feeds from external systems
...
Tools like the ones Spectra simulates — relationship graph analysers, location trackers, communication pattern detectors — are genuinely powerful and genuinely dangerous when used on real data without oversight.
...
This project was **deliberately built with generated data** as a first-class constraint, not as a shortcut. That choice reflects the following engineering ethic:

> **"You can demonstrate a capability without building a weapon."**

Demonstrating that you can build a relationship graph viewer or an anomaly detector does not require actually surveilling human beings. Building it on generated data is safer, and communicating that choice clearly is an act of professional responsibility.
...
|-----------|-------------|
| Ethics banner | Every page of the web app shows a persistent notice that all data is generated |
...
| Data watermark | Every generated record contains `"_synthetic": true` in its metadata |
...
*Spectra is a demo. Use knowledge responsibly.*
